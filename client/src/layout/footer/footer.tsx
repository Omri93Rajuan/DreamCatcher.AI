...
export default function Footer() {
  return (
    <footer className="relative bg-gradient-to-r from-black via-[#1a0000] to-red-900 py-6 border-t border-red-800 shadow-[0_-4px_15px_rgba(255,0,0,0.4)] text-center">
      {/* LinkedIn logo + link */}
      <motion.a
      ...
      >
        <svg
          ...
          viewBox="0 0 24 24"
          fill="white"
          className="drop-shadow-[0_0_10px_rgba(255,255,255,0.8)] hover:fill-red-500 transition-colors"
        >
          <path
