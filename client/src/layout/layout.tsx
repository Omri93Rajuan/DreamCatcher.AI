      ...
      <header className={[
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="h-16 flex items-center justify-between gap-4">
            ...
            <Link to={createPageUrl("HomePage")} className="flex items-center gap-2.5 group rounded-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-400/60" aria-label="דף הבית">
              <img src={logoMark} alt="פתרון חלומות - לוגו" className="w-16 h-16 transition-transform duration-200 group-hover:scale-105" decoding="async" loading="eager"/>
            ...
            <button onClick={() => setMobileOpen((v) => !v)} className="md:hidden inline-flex items-center justify-center w-10 h-10 rounded-lg border
                         border-black/10 hover:bg-black/5
                         dark:border-white/15 dark:hover:bg-white/10
                         transition" aria-label="תפריט" aria-expanded={mobileOpen}>
              <div className={[
            "relative w-5 h-5",
        ...
        {mobileOpen && (<div className="md:hidden fixed top-16 left-0 right-0 z-40
            ...
            <div className="max-w-7xl mx-auto px-4 py-3 flex flex-col gap-2">
              ...
              {user ? (<>
                  ...
                  <div className="mt-1 flex items-center justify-between">
                    <Link to="/register" onClick={() => setMobileOpen(false)} className="px-3.5 py-2 rounded-xl font-semibold
                                 text-slate-900 dark:text-white
                                 bg-gradient-to-l from-[#F59E0B] to-[#8B5CF6]
                                 hover:opacity-95
                                 shadow-[0_6px_20px_-10px_rgba(139,92,246,.35)]
      ...
      <footer className="border-t border-black/10 dark:border-white/10">
        <div className="max-w-7xl mx-auto px-4 py-10 text-center">
          <div className="flex items-center justify-center gap-3 mb-3">
            <img src={logoMark} alt="פתרון חלומות - סמל" className="w-12 h-12" loading="lazy" decoding="async"/>
