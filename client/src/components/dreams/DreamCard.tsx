...
type Props = {
  dream: Dream & { categories?: CategoryKey[] };
  showDate?: boolean;
  ...
  return (
    <span
      className={[
        ...
        // תמיד מציירים גרדיאנט של הקטגוריה (גם לייט וגם דרק)
        "bg-gradient-to-r",
        meta.gradient,
        // טקסט לבן לקריאות טובה על רוב הגרדיאנטים
        "text-white",
        // קונטור עדין שמפריד מהקרטיסה (שונה ללייט/דרק)
      ...
      {rest > 0 && (
        <span
          className="inline-flex items-center gap-1 px-2 py-1 rounded-full text-[11px] font-medium
            ...
            dark:bg-white/10 dark:text-white/90 dark:border-white/15"
  ...
  return (
    <>
        ...
        <CardContent className="p-5">
          ...
          {hasMore && (
            <button
              ...
              className="w-full mt-2 py-2 px-3 rounded-lg text-sm transition-colors
      ...
      {showModal && (
        ...
        >
          <div
            className="rounded-2xl max-w-3xl w-full max-h-[85vh] overflow-hidden
                       bg-white border border-black/10
                       dark:bg-gradient-to-br dark:from-purple-900/95 dark:via-purple-800/90 dark:to-purple-900/95 dark:border-2 dark:border-purple-500/30"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header */}
            <div
              className="sticky top-0 p-6 flex items-start justify-between gap-4 border-b
