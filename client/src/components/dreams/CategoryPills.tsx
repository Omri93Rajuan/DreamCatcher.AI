...
export default function CategoryPills({ selected, onSelect, showAll = true, initialVisible = 8, priorityOrder, }: Props) {
    ...
    return (<div className="relative mb-6" dir={i18n.dir()}>
      ...
      <div className="flex flex-col gap-4" onMouseMove={(e) => {
            (e.currentTarget.style as any).setProperty("--mx", `${e.nativeEvent.offsetX}px`);
        }}>
...
function AnimatedPill({ children, gradient, active, onClick, i = 0, }: {
