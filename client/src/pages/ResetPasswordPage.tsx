...
export default function ResetPasswordPage() {
    ...
    const { register, handleSubmit, formState: { errors, isSubmitting }, watch, } = useForm<FormData>({ resolver: zodResolver(schema), mode: "onBlur" });
    ...
    return (<section className="max-w-md mx-auto p-6" dir="rtl">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div>
          ...
          {errors.password && (<p className="text-xs text-rose-500 mt-1">
        ...
        <div>
          ...
          {errors.confirm && (<p className="text-xs text-rose-500 mt-1">
